...
class FakeCursor:
    def __init__(self, conn):
        self.conn=conn; self._one=None; self._all=[]; self.rowcount=0
    ...
    def executemany(self, sql, params_seq):
        if "INSERT INTO pgintel.query_samples" not in sql:
            raise AssertionError(sql)
...
class RepositorySafetyTests(unittest.TestCase):
    ...
    def test_unchanged_statement_is_not_stored(self):
        prev={"dbid":1,"userid":2,"queryid":3,"plans_raw":0,"calls_raw":10,"total_plan_time_raw":0.0,"total_exec_time_raw":100.0,"rows_raw":10,
    ...
    def test_changed_statement_is_stored(self):
        prev={"dbid":1,"userid":2,"queryid":3,"plans_raw":0,"calls_raw":9,"total_plan_time_raw":0.0,"total_exec_time_raw":90.0,"rows_raw":9,
